...
import {Api5} from "./Api"; // Assuming About is an array of questions and answers
import "./index.css"; // Add necessary CSS
import { Visibility, VisibilityOff } from "@material-ui/icons";
import { Link } from "react-router-dom";

const  Socialmedia= () => {
  const [data, setData] = useState(Api5);
  ...
  return (
    <>
      <div className="mainDiv" id="maindivId5">
        <div className="container">
          <h6 className="topicName mt-2 text-center text-white display-6" style={{ textShadow: "2px 2px 4px black" }}>Internet & Social Media</h6>
          <div className="mt-4">
