...
import {Api6} from "./Api"; // Assuming About is an array of questions and answers
...
const  Tradition= () => {
  const [data, setData] = useState(Api6);
  ...
  return (
    <>
      <div className="mainDiv" id="maindivId6">
        <div className="container">
          <h6 className=" topicName mt-2 text-center text-white display-6" style={{ textShadow: "2px 2px 4px black" }}>Festival & Tradition</h6>
          <div className="mt-4">
